...
locs<-read.csv('Brachynopus_scutellaris.csv')
View(locs)
...
dir.create('~/MaxEnt_Brachy') #maxent writes a lot of output files so you will want a new directory for each run
xm <- maxent(predictors, locs, removeDuplicates=TRUE, nbg=1000, path='MaxEnt_Brachy') # Builds a Maxent model
...
xm@results
write.csv (xm@results, 'MaxEnt_Brachy/Rmaxent_Brachy.csv')
...
writeRaster(result, "MaxEnt_Brachy/Rmaxent_Brachy_current", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
#this just saved the raster layer, not that figure that has the localities or legend.
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_current.pdf') #This file will not over-write, must delete if rerunning the command
...
plot(e1, 'ROC')
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_AUC1.pdf')
...
plot(e2, 'ROC')
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_AUC2.pdf')
...
plot(e3, 'ROC')
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_AUC3.pdf')
...
plot(e4, 'ROC')
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_AUC4.pdf')
...
plot(e5, 'ROC')
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_AUC5.pdf')
...
writeRaster(result, "MaxEnt_Brachy/Rmaxent_Brachy_LGMresult", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_LGM.pdf') #Saving the figure
...
plot(Futresult)
setwd("C:/Users/kamarske/Dropbox/Comp Sci Workshop")
writeRaster(Futresult, "MaxEnt_Brachy/Rmaxent_Brachy_2050result", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Brachy/Rmaxent_Brachy_2050.pdf') #Saving the figure
