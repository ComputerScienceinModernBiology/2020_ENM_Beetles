...
locs<-read.csv('Geochus_tibialis.csv')
View(locs)
...
dir.create('~/MaxEnt_Geo') #maxent writes a lot of output files so you will want a new directory for each run
xm <- maxent(predictors, locs, removeDuplicates=TRUE, nbg=1000, path='MaxEnt_Geo') # Builds a Maxent model
...
xm@results
write.csv (xm@results, 'MaxEnt_Geo/Rmaxent_Geo.csv')
...
writeRaster(result, "MaxEnt_Geo/Rmaxent_Geo_current", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
#this just saved the raster layer, not that figure that has the localities or legend.
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_current.pdf') #This file will not over-write, must delete if rerunning the command
...
plot(e1, 'ROC')
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_AUC1.pdf')
...
plot(e2, 'ROC')
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_AUC2.pdf')
...
plot(e3, 'ROC')
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_AUC3.pdf')
...
plot(e4, 'ROC')
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_AUC4.pdf')
...
plot(e5, 'ROC')
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_AUC5.pdf')
...
writeRaster(result, "MaxEnt_Geo/Rmaxent_Geo_LGMresult", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_LGM.pdf') #Saving the figure
...
plot(Futresult)
setwd("C:/Users/kamarske/Dropbox/Comp Sci Workshop")
writeRaster(Futresult, "MaxEnt_Geo/Rmaxent_Geo_2050result", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Geo/Rmaxent_Geo_2050.pdf') #Saving the figure
