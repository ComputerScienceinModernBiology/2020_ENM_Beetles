...
xm@results
write.csv (xm@results, 'MaxEnt_Agyrt/Rmaxent_Agyrt.csv')
...
writeRaster(result, "MaxEnt_Agyrt/Rmaxent_Agyrt_current", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
#this just saved the raster layer, not that figure that has the localities or legend.
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_current.pdf') #This file will not over-write, must delete if rerunning the command
...
plot(e1, 'ROC')
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_AUC1.pdf')
...
plot(e2, 'ROC')
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_AUC2.pdf')
...
plot(e3, 'ROC')
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_AUC3.pdf')
...
plot(e4, 'ROC')
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_AUC4.pdf')
...
plot(e5, 'ROC')
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_AUC5.pdf')
...
writeRaster(result, "MaxEnt_Agyrt/Rmaxent_Agyrt_LGMresult", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_LGM.pdf') #Saving the figure
...
plot(Futresult)
setwd("C:/Users/kamarske/Dropbox/Comp Sci Workshop")
writeRaster(Futresult, "MaxEnt_Agyrt/Rmaxent_Agyrt_2050result", format="ascii", overwrite=TRUE) #Saving your result as an ascii file
dev.print(pdf, 'MaxEnt_Agyrt/Rmaxent_Agyrt_2050.pdf') #Saving the figure
